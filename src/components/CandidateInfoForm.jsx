  ...
  return (
    <>
      ...
      <div className="space-y-2">
        ...
        <input
          className="w-full border-2 border-gray-300 rounded-xl p-4 focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-all duration-200 bg-white text-gray-900 shadow-sm hover:border-gray-400 placeholder-gray-400"
