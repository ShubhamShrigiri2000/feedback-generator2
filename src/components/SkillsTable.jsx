              ...
              <tr key={index} className="hover:bg-gray-50 transition-colors duration-150">
                ...
                <td className="p-3">
                  <input
                    ...
                    min="1"
                    max="5"
                    className="w-full p-2 border-2 border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-all bg-white text-gray-900 font-semibold placeholder-gray-400"
                    placeholder="1-5"
                    value={skill.rating}
